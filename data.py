...
# Extraction transform: Ensures raw images are normalized to single-channel tensors 
# before hashing or embedding verification.
...
def get_raw_datasets():
    ...
    # --------------------------------------------------------
    # FORENSIC LEAKAGE AUDIT (MD5 Verification)
    # --------------------------------------------------------
...
def get_dataloaders():
    ...
    Standard: Implements the 'Seed Worker' protocol for absolute reproducibility.
    """
